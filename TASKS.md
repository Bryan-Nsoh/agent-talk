...
## Task 1: Analyze a Reference Paper
- Select a well-produced research paper to serve as a template.
- Capture concrete heuristics: section order, float placement, how figures are referenced, narrative flow cues, typography conventions.
- Summarize findings in `notes/reference-paper-heuristics.md` (outline, bullet rules, representative quotes or screenshots as needed).
